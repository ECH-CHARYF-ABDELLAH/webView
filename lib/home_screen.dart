      ...
      ..setNavigationDelegate(
        NavigationDelegate(
          onPageStarted: (String url) {
            setState(() {
// Set loading to true when a page starts loading
            });
          },
          onPageFinished: (String url) {
            setState(() {
// Set loading to false when the page finishes loading
            });
          },
          onNavigationRequest: (NavigationRequest request) async {
            ...
            if (request.url.startsWith("tel:")) {
              // Open WhatsApp link in external app
              await EasyLauncher.call(number: "+212655600691");
      ...
      ..loadRequest(Uri.parse('https://multikhadamat.ma/'));
  }
